...
class MCAPI {
     ...
     * @param string $secure whether or not this connection uses HTTPS
     */
    ...
    */
     ...
     * @returnf string web_id The Campaign id used in our web app, allows you to create a link directly to it
     ...
     * @returnf string web_id The list id used in our web app, allows you to create a link directly to it
     ...
     * next time you call Get by visiting <a href="http://admin.mailchimp.com/account/api" target="_blank">your API dashboard</a>. If you are trying to shut off access to your account for an old developer, change your 
