...
?>
  <?php print $head; ?>
<link rel="stylesheet" href="http://f.fontdeck.com/s/css/D8Fz3XWt+VC0VDejQHe7Mks5Qzc/vitamindaily.com/18728.css" type="text/css" />
  <?php print $styles; ?>
  <?php print $scripts; ?>
  ...
  <div id="container">
      ...
      <div id="sidebar-right" class="column sidebar">
        ...
        <?php print DailyDose_rogersAd('bigbox', $city->nid, arg(1)); //rogers ads - bigbox ?>
  			<!-- Daily Deals Widget -->
				<iframe frameborder="0" height="250" width="300" allowtransparancy="true" src="http://vitamindailydeals.com/widget/channel/vitamindailydeals-vancouver/medium-rectangle/?utm_source=SOURCE"></iframe>
				<!-- /CLOSE Daily Deals Widget Start -->	
      ...
      <?php if ($header || $breadcrumb): ?>
        <div id="header-region">
          <?php print $header; ?>
					...
					<?php //social media links are here because they are unique per city ?>
					<div id="social-list">
						<a href="http://www.facebook.com/vitamindaily1" title="Like us on Facebook" id="social-facebook"></a>
						<a href="http://pinterest.com/vitamindaily/" id="social-pintrest"></a>
						<a href="http://twitter.com/#!/vanvitamindaily" title="Follow us on Twitter" id="social-twitter"></a>
						<a href="http://itunes.apple.com/ca/app/vitaminvan/id451183777?mt=8" title="Download the Vitamin Daily Vancouver app" id="social-appstore"></a>
					</div>
